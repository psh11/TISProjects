							...
							<div class="cart_cont">
								<div class="container">
							      <div class="row">
							        ...
							        <div class="col-md-9">
							        	<form method="post" action="../admin/productreg" enctype="multipart/form-data" name="insertform" onsubmit="return productCheck()">
					                        <h3 class="t-p">상품등록</h3>
					                        <table class="table">
					                            <tbody>
					                                <tr>
					                                    <th>상품명</th>
					                                ...
					                                <tr>
					                                    <th>상품코드</th>
					                                    <td class="" colspan="4">
					                                        <input type="text" name="code" id="code" placeholder="코드3자리" />
					                                    </td>
					                                </tr>
					                                <tr>
					                                    <th>판매가</th>
					                                    <td class="" colspan="4">
					                                        <input type="text" name="price" id="price" placeholder="0" />원
					                                    </td>
					                                </tr>
					                                <tr>
					                                    <th>첨부파일</th>
