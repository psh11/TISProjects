			...
			<div id="contents">
				<div class="location_wrap">
					<div class="location_cont">
						<em><a href="../main.jsp" class="local_home">HOME</a> &gt; 관리자페이지</em>
					</div>
				</div>
							...
							<div class="cart_cont">
								<div class="container">
							      <div class="row">
							        ...
							        <div class="col-md-10">
			                        <h3 class="t-p">상품목록</h3>
							        	<form class="searchform">
							        	<fieldset style="text-align: right;">
					                        <select name="f">
					                        	<option value="product_name" ${param.f=="product_name"?"selected":""} >상품명</option>
					                        	<option value="product_code" ${param.f=="product_code"?"selected":""}>상품코드</option>
					                        </select>
					                        <label>검색어</label>
							        	...
							        	<form method="get" action="../admin/productlist" style="padding: 10px;">
					                        <table class="table">
					                        	<thead>
					                        		<tr>
					                        		<th scope="col" style="text-align: center; " class="">번호</th>
													<th scope="col" style="text-align: center; width: 350px;" class="">상품명</th>
													<th scope="col" style="text-align: center; width: 200px;" class="">첨부파일</th>
													<th scope="col" style="text-align: center; " class="">상품코드</th>
					                            ...
					                            <tbody>
					                            	<c:forEach var="pd" items="${list}">
						                                <tr>
						                                <td scope="row" style="text-align: center;">${pd.product_id}</td>
						                                <td scope="row" style="padding-left: 20px;"><b>[ ${pd. product_name} ]</b></td>
						                                <td scope="row" style="text-align: center;"><fmt:formatNumber value="${pd.product_price}" pattern="#,###" />원</td>
						                                <td scope="row" style="text-align: center;">${pd.product_code }</td>
						                                <td scope="row" style="text-align: center;">
						                                	<a class="badge bg-info text-white" href="../admin/productdetail?id=${pd.product_id}">보기</a>
						                                </td>
						                                <td scope="row" style="text-align: center;">
						                                	<a class="badge bg-info text-white" href="../admin/productedit?id=${pd.product_id}">수정</a>
						                                </td>
						                                <td scope="row" style="text-align: center;">
						                                	<a class="badge bg-danger" href="../admin/Tis_webAdmin_del.jsp?id=${pd.product_id}&name=${pd.product_name}">
					                             	...
					                             	<c:if test="${pStart > 5}">
						                             	<b><a href="productlist?f=&q=&p=${pStart-5}">[이전]</a></b>
					                             	</c:if>
					                             	<c:forEach var="i" begin="${pStart}" end="${pEnd}" step="1">
						                             	<b><a href="productlist?f=&q=&p=${i}" style="color: ${(pN==i)?'#ED0000;':'#828282;'}"> [${i}] </a></b>
					                             	</c:forEach>
					                             	<c:if test="${(pStart+5) <= pageCount}">
						                             	<b><a href="productlist?f=&q=&p=${pStart+5}">[다음]</a></b>
						                             </c:if>
					                             	</td>
					                             	</tr>
					                            </tbody>
